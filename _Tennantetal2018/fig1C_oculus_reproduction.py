...
for dcount, day in enumerate(days):
    for mcount, mouse in enumerate(mice):
        ...
        try:
            ...
            continue
        trialno = np.max(
            saraharray[:, 9])  # total number of trials for that day and mouse (used later for defining y axis max)
        ...
        try:
            if stopsdata_p.size > 0:  # if there are probe trials, plot 3x3 subplots
                ...
                ax.axvspan(8.8, 8.8 + 2.2, facecolor='DarkGreen', alpha=0.25, hatch='/',
                ...
                ax.axvspan(44, 44 + 11, facecolor='g', alpha=0.25, hatch='/',
                           linewidth=0)  # green box spanning the rewardzone to mark reward zone
                ...
                ax.axvspan(44, 44 + 11, facecolor='g', alpha=0.2, hatch='/',
                           linewidth=0)  # green box spanning the rewardzone to mark reward zone
                ...
                ax.axvspan(44, 44 + 11, facecolor='g', alpha=0.3, hatch='/',
                           linewidth=0)  # green box spanning the rewardzone to mark reward zone
                ...
                fig.savefig('/home/harry/PycharmProjects/VRnav/Tennantetal2018/Plots/Figure1/ExampleData/ExampleData' + '_' + str(mouse) + '_' + str(day) + '.png',
                            dpi=200)
                plt.close()
                ...
                ax = fig.add_subplot(3, 3, 4)
                ax.axvspan(44, 44 + 11, facecolor='DarkGreen', alpha=0.25, hatch='/',
                           linewidth=0)  # green box spanning the rewardzone to mark reward zone
                ax.axvspan(0, 15, facecolor='k', alpha=0.15, hatch='/', linewidth=0)  # black box
                ax.axvspan(100 - 15, 100, facecolor='k', alpha=0.15, hatch='/', linewidth=0)  # black box
                ax.axvline(0, linewidth=3, color='black')
                ...
                ax.fill_between(bins * 5, srbin_mean_b - srbin_std_b, srbin_mean_b + srbin_std_b, facecolor='blue',
                                alpha=0.3)
                ...
                ax.fill_between(bins * 5, srbin_mean_nb - srbin_std_nb, srbin_mean_nb + srbin_std_nb, facecolor='blue',
                                alpha=0.3)
