...
# import packages and functio
from Functions_Core_0100 import extractstops_HUMAN, filterstops, create_srdata, makebinarray, shuffle_analysis_pertrial3, z_score1, adjust_spines,readhdfdata,maketrialarray, makelegend_upright, makelegend_midright, makelegend_lowright
import numpy as np
...
# stack experiments for short trials then average over days then mice
...
ax.plot(bins,con_nb_s,color = 'black',label = 'Non-Beaconed', linewidth = 2) #plot beaconed trials
ax.fill_between(bins , con_nb_s-sd_con_nb_s, con_nb_s+sd_con_nb_s, facecolor = 'black', alpha = 0.3)
...
ax.plot(bins,con_nb_m,color = 'black',label = 'Non-Beaconed', linewidth = 2) #plot beaconed trials
ax.fill_between(bins, con_nb_m-sd_con_nb_m, con_nb_m+sd_con_nb_m, facecolor = 'black', alpha = 0.3)
...
ax.plot(bins,con_nb_l,color = 'black',label = 'Non-Beaconed', linewidth = 2) #plot beaconed trials
ax.fill_between(bins, con_nb_l-sd_con_nb_l, con_nb_l+sd_con_nb_l, facecolor = 'black', alpha = 0.3)
...
ax.plot(bins, con_p_l, '', color='red', label='Prob e', linewidth=2)  # plot probe trials
ax.fill_between(bins, con_p_l-sd_con_p_l, con_p_l+sd_con_p_l, facecolor='red', alpha=0.3)
...
fig.savefig('/Users/emmamather-pike/PycharmProjects/data/plots/Fig1F2_SML_3x3_ZScoreHist'+'.png', dpi = 200)
plt.close()
