...
def main():
    ...
    model_params = fit(human_data, save_path, trial_type="beaconed", model_parameters_df=model_params, constraints="experiment")
    model_params = fit(human_data, save_path, trial_type="non_beaconed", model_parameters_df=model_params, constraints="experiment")
    model_params.to_pickle(save_path+"/model_parameters.pkl")
